  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="text-error hover:bg-error/10 border-error absolute top-4 right-4 cursor-pointer rounded-sm border p-1 transition-all duration-150 focus:outline-none">
